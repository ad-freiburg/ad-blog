...
### Existing Operations
To test this, two versions of a `qlever-server` are compared on the same datasets and queries. For the build without the changes from this project, the last commit before these changes was used ([fff97cadb5ebf481e5873c73ce9786cbb2f9e71e](https://github.com/ad-freiburg/qlever/commit/fff97cadb5ebf481e5873c73ce9786cbb2f9e71e)).The second build contained every change from this project ([44dd294c31798ae480df7d0271c564af994eb033](https://github.com/yarox-1/qlever/commit/44dd294c31798ae480df7d0271c564af994eb033)). The dataset consists of 30,000 random `xsd:int`/`xsd:decimal`s. As the result of the operations does not matter here, this is enough to get 900,000,000 computations via the cartesian product. Simple queries were used that computed the sum of the results of the 900,000,000 subtractions/additions. Using this it could also be ensured that the computation results did not change between the two versions. Example query for the subtraction of `xsd:int`:
```sparql
PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
