...
authorAvatar: "img/christina_davril.png"
...
categories: ["project"]
image: "img/wikidata_tastydata_cropped_white.svg"
draft: false
---
...
<figure>
<img id="nodes_black" alt="Wikidata pros and cons" src="img/wikidata_nodes_in_black_modified_narrower.svg">
<figcaption>
...
<figure>
<img id="question_query_pair" alt="Example of a question-query pair." src="img/question_query_example.svg">
...
<figure>
<img id="statement_nodes" alt="Example of statement nodes" src="img/statement_nodes_lafontaine.svg">
<figcaption>
...
<table>
  ...
  <tbody>
	...
	<tr>
	  ...
	  <td>2023</td>
	  <td><a href="img/wikipedia_lists.json">JSON</a></td>
	  <td>[no publication]</td>
	  <td>11</td>
...
<figure>
<img id="football_list" alt="Example 2 of a Wikipedia list" src="img/danish_football_transfers.svg">
...
The dataset file, <a href="other_files/wikipedia_lists.json" style="background-color:#ff9999;display:block;text-align:center;margin:0.75em 0 0.75em 0;">**wikipedia_lists.json**</a> contains the following information for each example:
<UL>
...
<figure>
<img id="wiki_list1" alt="Example 1 of a Wikipedia list" src="img/largest_cities_capitals.svg">
...
<figure>
<img id="query_for_wiki_list1" alt="Output of query corresponding to Example 1 of a Wikipedia List" src="img/cities_query.svg">
...
<a href="img/list_type_queries.svg" style="background-color:#ff9999;display:block;text-align:center;margin:0.75em 0 0.75em 0;">**list_type_queries.svg**</a>
...
<figure>
<img id="1_selection_of_items" alt="Excerpt from the graphical overview, showing step 1" src="img/1_selection_of_items.svg">
...
<figure>
<img id="2_accessing_simple_property_values" alt="Excerpt from the graphical overview, showing step 2b, 1/3" src="img/2_accessing_simple_property_values.svg">
...
<figure>
<img id="2_accessing_complex_property_values_A" alt="Excerpt from the graphical overview, showing step 2b, 2/3" src="img/2_accessing_complex_property_values_A.svg">
...
<figure>
<img id="2_accessing_complex_property_values_B" alt="Excerpt from the graphical overview, showing step 2b, 3/3" src="img/2_accessing_complex_property_values_B.svg">
...
<figure>
<img id="3_output_config" alt="Excerpt from the graphical overview, showing step 3" src="img/3_output_config.svg">
...
<a href="other_files/semantic_sparql_templates.pdf" style="background-color:#ff9999;display:block;text-align:center;margin:0.75em 0 0.75em 0;">**semantic_sparql_templates.pdf**</a>
...
Having listed the most important syntactic building blocks, their general semantic purposes, and how they can be combined, the templates with the highest syntactic complexity will be looked at more closely: the ones containing subqueries (Variants 1-6 in the <a href="other_files/semantic_sparql_templates.pdf">PDF</a>).<br>
...
<figure>
<img id="variant_2" alt="Example query for Variant 2" src="img/heads_of_state.svg">
...
<figure>
<img id="variant_3" alt="Example query for Variant 3" src="img/nba_winners.svg">
...
<figure>
<img id="variant_4" alt="Example query for Variant 4" src="img/galapagos_hawaiian.svg">
...
<figure>
<img id="variant_5" alt="Example query for Variant 5" src="img/pandemics.svg">
...
<figure>
<img id="variant_6" alt="Example query for Variant 6, containing nested subqueries" src="img/nested_subqueries.svg">
